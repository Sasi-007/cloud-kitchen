  ...
  return (
    <nav style={{
      ...
      <Link href="/" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <span style={{ fontWeight: 900, fontSize: '1.2rem', color: 'var(--primary)' }}>CloudKitchen</span>
        <span style={{ fontSize: '0.65rem', background: 'var(--primary)', color: '#fff', borderRadius: 6, padding: '2px 6px', fontWeight: 700, marginLeft: 2 }}>PLATFORM</span>
      </Link>
